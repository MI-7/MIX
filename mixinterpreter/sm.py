...
class Constant(MySM):
    ...
    def getNextValues(self, state, inp, verbose=False):
        if verbose:
            print('Constant..' + ' In: ' + str(inp) + ' Out: ' + str(self.startState) + ' Next State: ' + str(
                self.startState))
...
class Increment(MySM):
    ...
    def getNextValues(self, state, inp, verbose=False):
        if verbose:
            print('Increment..' + ' In: ' + str(inp) + ' Out: ' + str(safeAdd(inp, self.incr)) + ' Next State: ' + str(
                safeAdd(inp, self.incr)))
...
class Adder(MySM):
    ...
    def getNextValues(self, state, inp, verbose=False):
        ...
        if verbose:
            print('Adder..' + ' In: ' + str(inp) + ' Out: ' + str(safeAdd(i1, i2)) + ' Next State: ' + str(
                safeAdd(i1, i2)))
...
class Multiplier(MySM):
    ...
    def getNextValues(self, state, inp, verbose=False):
        (i1, i2) = splitValue(inp, 2)
        if verbose:
            print('Multiplier..' + ' In: ' + str(inp),
                  ' Out: ' + str(safeMultiply(i1, i2)) + ' Next State: ' + str(safeMultiply(i1, i2)))
...
class DoubleDelay(MySM):
    ...
    def getNextValues(self, state, inp, verbose=False):
        ...
        if verbose:
            print(
                'Double Delay..' + ' In: ' + str(inp) + ' Out: ' + str(ppstate) + ' Next State: ' + str((pstate, inp)))
...
class TripleDelay(MySM):
    ...
    def getNextValues(self, state, inp, verbose=False):
        ...
        if verbose:
            print('Triple Delay..' + ' In: ' + str(inp) + ' Out: ' + str(pppstate) + ' Next State: ' + str(
                (ppstate, pstate, inp)))
